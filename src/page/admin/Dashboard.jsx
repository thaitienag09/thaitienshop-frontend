...
const stats = [
    // { title: 'Tổng doanh thu', value: '12,450,000đ', icon: CreditCard, change: '+12.5%', isUp: true },
    // { title: 'Đơn hàng mới', value: '24', icon: ShoppingBag, change: '+5.2%', isUp: true },
